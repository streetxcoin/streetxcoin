...
"Copyright &copy; 2011-YYYY The StreetXCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About StreetXCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>StreetXCoin</b> version", 0));
